        ...
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p className="about-description">
              ...
              the necessary knowledge and skills to become effective leaders in
              their respective spheres of influence. CLA&apos;s curriculum is
              designed to integrate biblical principles and teachings,
            ...
            <div className="highlight-text">
              <p>
                ...
                to make Christian leadership training accessible to a wider
                audience, regardless of their financial background. By removing
                financial barriers, CLA aims to create an inclusive environment
                where individuals from diverse backgrounds can come together,
            ...
            <p className="about-description">
              ...
              nurturing space for students to deepen their understanding of
              scripture, develop their leadership abilities, and cultivate a
              closer relationship with God. By prioritizing spiritual growth,
              the Academy hopes to empower its graduates to become servant
              transformational leaders who can positively impact their
